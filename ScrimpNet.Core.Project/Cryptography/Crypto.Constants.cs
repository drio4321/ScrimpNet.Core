...
namespace ScrimpNet.Cryptography
{
    public partial class Crypto
    {
        ...
        {
            public const string PublicKeyOnly = "scrimpnet.com/cryptography/segment/publicKeyOnly";
            public const string PublicPrivateKey = "scrimpnet.com/cryptography/segment/publicPrivateKey";
        ...
        public class PropertyNames
        {
            ...
            public const string HashSimpleMode = "scrimpnet.com/cryptography/property/simpleHashMode";
        ...
        public class EncodeModes
        {
            ...
            public const string RSA = "scrimpnet.com/cryptography/mode/rsa";
