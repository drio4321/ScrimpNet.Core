...
{
    /// <summary>
    /// A key is simply a container of named byte arrays that are grouped together and can be transported together.  Different encryption algorithms and deploy strategies have different component requirements (single, double, n-count)
    /// and this container
    /// </summary>
    [Serializable]
    ...
    public class CryptoKey
    {
        ...
        /// <summary>
        /// Named series of metadata that give additional information about this key.  It might contain encryption type, life span, or any other implementation specific information.  NOTE:  It is likely these properties are not
        /// automatically encrypted on serialization operations.  Do not include senstitive information here.
        /// </summary>
        [DataMember]
        public CryptoProperties Properties { get; set; }
